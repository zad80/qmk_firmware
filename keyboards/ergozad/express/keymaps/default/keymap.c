...
[BASE] = LAYOUT_ergodox(
  ...
  KC_BSPC,         KC_A,        KC_S,          KC_D,    KC_F,    KC_G,  ALT_T(KC_NO),                        ALT_T(KC_APP), KC_LGUI,//9
  KC_LSFT,         CTL_T(KC_Z), KC_X,          KC_C,    KC_V,    KC_B,                                                      KC_HOME,//7
  LT(SYMB,KC_GRV), KC_QUOT,     LALT(KC_LSFT), KC_LEFT, KC_RGHT,                                           KC_SPC, KC_BSPC, KC_END,//8
  // right hand
  KC_RGHT,      KC_6,    KC_7,    KC_8,    KC_9,              KC_0,           KC_MINS,//7
  TG(SYMB),     KC_Y,    KC_U,    KC_I,    KC_O,              KC_P,           KC_BSLS,//7
  KC_H,         KC_J,    KC_K,    KC_L,    LT(MDIA, KC_SCLN), GUI_T(KC_QUOT),ALT_T(KC_APP), KC_LGUI, KC_RSFT,//9
  KC_N,    KC_M,    KC_COMM, KC_DOT,            CTL_T(KC_SLSH), KC_UP,        KC_DOWN, //7
  KC_LBRC, KC_RBRC, TT(SYMB), KC_LALT, CTL_T(KC_ESC),KC_PGUP, KC_PGDN, KC_TAB
),
